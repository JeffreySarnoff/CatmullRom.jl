...
|:---------------------------------------------------------------------------------------------------------------------------:|:--|
| <img src="https://github.com/JeffreySarnoff/CatmullRom.jl/blob/master/examples/assets/Catmull-Rom_Spline.png" width="500">  | The point sequence will be modified in place. Catmull-Rom splines use four points to generate an arc connecting the central two points. For your initial and final points to appear, two new endpoints must be affixed.  |
