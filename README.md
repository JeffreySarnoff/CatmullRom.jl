...
|:---------------------------------------------------------------------------------------------------------------------------:|:--|
| <img src="https://github.com/JeffreySarnoff/CatmullRom.jl/blob/master/examples/assets/Catmull-Rom_Spline.png" width="500">  | The point sequence that is used will be modified in place (a point will be prepended and a point will be postpended). |
